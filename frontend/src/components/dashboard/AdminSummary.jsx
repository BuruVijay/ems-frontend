...
import { FaBuilding, FaCheckCircle, FaFileAlt, FaHourglassHalf, FaMoneyBillAlt, FaTimesCircle, FaUsers } from 'react-icons/fa'
...
const AdminSummary = () => {
  ...
  useEffect(()=>{
    const fetchSummary= async ()=>{
      try {
        const summary= await axios.get(`http://localhost:5000/api/admin-dashboard/summary`,{
          headers:{
  ...
  return (
    <div className='p-6'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-4 mt-6 '>
            ...
            <SummaryCard icon={<FaMoneyBillAlt/>} text="Monthly Salary" number={summary.totalSalary} color="bg-red-600"/>
        </div>
