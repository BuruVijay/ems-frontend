  ...
  return (
    <div className='bg-gray-800 text-white h-screen fixed left-0 top-0 bottom-0 space-y-2 w-64'>
        ...
        <div className='px-4'>
            ...
            className={({isActive})=> `${isActive ? "bg-teal-400" : ""} items-center space-x-4 flex py-2.5 px-4 rounded`} end>
                <FaTachometerAlt/>
                    <span>Dashboard</span>
            </NavLink>
           ...
           className={({isActive})=> `${isActive ? "bg-teal-400" : ""} items-center space-x-4 flex py-2.5 px-4 rounded`} end>
            ...
            className={({isActive})=> `${isActive ? "bg-teal-400" : ""} items-center space-x-4 flex py-2.5 px-4 rounded`}>
                <FaBuilding/>
                    <span>Leaves</span>
            </NavLink>
