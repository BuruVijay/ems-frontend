        ...
        const fetchDepartments=async ()=>{
            ...
            try {
                ...
                if(response.data.success)
                    {
                        let sno=1;
                        const data= response.data.departments.map((d)=>(
                            {
                                
                                _id:d._id,
                                sno: sno++,
                                dep_name: d.dep_name,
                                action:(<DepartmentButtons _id={d._id} onDepartmentDelete={onDepartmentDelete}/>)
                            }
                        ))
                    setDepartments(data);
    ...
    return (
        ...
        <div className='p-5'>
            ...
            <div className='flex justify-between items-center '>
                <input type="text" onChange={filterDepartments} placeholder='Search By Dep Name' className='px-4 py-0.5 border' />
