    ...
    <div className='max-w-3xl mx-auto mt-10 bg-white p-8 rounded-md shadow-md w-96'>
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className='mt-3'>
                ...
                <textarea name="description" value={department.description} onChange={handleChange}placeholder='Description' className='mt-1 p-2 block w-full border border-gray-300 rounded-md' rows="4"></textarea>
            </div>
