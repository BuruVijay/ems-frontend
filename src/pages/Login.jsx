...
const Login = () => {
  ...
  return (
    <div className='flex flex-col items-center h-screen justify-center bg-gradient-to-b from-teal-600  to-gray-100 to-70% space-y-6'>
        <h2 className='text-2xl font-sans font-bold mb-4'>Employee Management System</h2>
